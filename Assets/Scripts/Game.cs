    ...
    public class Game : MonoBehaviour, IPersistentObject
    {
        ...
        void Start()
        {
            ...
            else if (SceneManager.sceneCount == 2)
            {
                ...
                activeScene = SceneManager.GetActiveScene();
                currentLevel = activeScene.buildIndex;
            }
            else
            {
        ...
        ///<summary>Завершает текущий уровень</summary>
        public void CompleteLevel()
        {
            ...
            completedLevel = true;
            storage.Save(this);
            gameView.OpenPopWindow();
        }

        ///<summary>Загружает следующий уровень при условии, что текущий завершён</summary>
        ...
        ///<summary>Перезагружает текущий уровень</summary>
